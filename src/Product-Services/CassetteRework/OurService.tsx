    ...
    return (
        <section id="OurServices">
                <div className="pt-10 max-w-2xl mx-auto text-center mb-5 lg:mb-10 ">
                    ...
                    <p className="mt-1 text-gray-600 px-2 ">Specialized cassette rework services to maintain cash handling reliability.</p>
                </div>
    ...
    const projects = [
        {
            ...
            imageUrl: "/images/cassette-rework-service1.JPG",
            description:
                "Regular cleaning and preventive maintenance to ensure cassettes function smoothly and prevent cash jams.",

        },
        {
            title: "Component Repair    ",
            imageUrl: "/images/cassette-rework-service2.JPG",
            description:
                "Repairing worn-out mechanical parts, locks, and sensors to restore cassette performance.",
        },
        {
            title: "Testing & Quality Assurance ",
            imageUrl: "/images/cassette-rework-service3.JPG",
            description:
                "Testing reworked cassettes under real conditions to ensure durability, accuracy, and compliance with ATM standards.",
        },
    ];