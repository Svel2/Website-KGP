    ...
    return (
        <section id="OurServices">
                <div className="pt-10 max-w-2xl mx-auto text-center mb-5 lg:mb-10 ">
                    ...
                    <p className="mt-1 text-gray-600 px-2 ">Specialized ATM module repair and rework services to maintain uptime and reduce operational costs for financial institutions.</p>
                </div>
    ...
    const projects = [
        {
            ...
            imageUrl: "/images/monitoring-service1.jpg",
            description:
                "Tracking ATM and IT systems 24/7 using monitoring dashboards and automated alerts for immediate awareness.",

        },
        {
            title: "Proactive Alerts",
            imageUrl: "/images/monitoring-service2.jpg",
            description:
                "Sending instant notifications to call center and field engineers when potential issues are detected.",
        },
        {
            title: "Performance Reports",
            imageUrl: "/images/monitoring-service2.jpg",
            description:
                "Delivering detailed system health and uptime reports to support management decisions and service improvements.",
        },
