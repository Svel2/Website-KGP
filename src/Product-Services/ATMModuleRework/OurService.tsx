    ...
    const projects = [
        {
            ...
            description:
                "Comprehensive repair of ATM modules with advanced diagnostics and standardized quality processes to restore functionality.",
        ...
        },
        {
            ...
            description:
                "Rigorous testing procedures to ensure every reworked module meets operational standards, reliability, and compliance.",
        },
