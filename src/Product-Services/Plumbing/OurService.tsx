    ...
    return (
        <section id="OurServices">
                <div className="pt-10 max-w-2xl mx-auto text-center mb-5 lg:mb-10 ">
                    ...
                    <p className="mt-1 text-gray-600 px-2 ">Comprehensive plumbing solutions for modern infrastructure projects, ensuring durability, efficiency, and compliance with industry standards.</p>
                </div>
    ...
    const projects = [
        {
            ...
            imageUrl: "/images/plumbing-service1.jpg",
            description:
                "Professional installation of water supply networks, ensuring reliable and efficient distribution across residential, commercial, and industrial buildings.",

        },
        {
            title: "Drainage & Sewage Systems",
            imageUrl: "/images/plumbing-service2.jpg",
            description:
                "Expert solutions for drainage, sewage, and waste disposal systems designed to meet health, safety, and sustainability requirements.",
        },
    ];