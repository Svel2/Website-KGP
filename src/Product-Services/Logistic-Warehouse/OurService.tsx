    ...
    return (
        <section id="OurServices">
                <div className="pt-10 max-w-2xl mx-auto text-center mb-5 lg:mb-10 ">
                    ...
                    <p className="mt-1 text-gray-600 px-2 ">Integrated logistics and warehouse management tailored for financial and technology industries.</p>
                </div>
    ...
    const projects = [
        {
            ...
            description:
                "Providing safe and organized storage facilities for ATM spare parts, IT equipment, and sensitive materials with full monitoring.",
        ...
        },
        {
            ...
            description:
                "Efficient transportation and delivery services ensuring equipment reaches branch locations on time and in perfect condition.",
        },
        {
            title: "Inventory Management",
            imageUrl: "/images/logistic-service3.jpg",
            description:
                "Real-time tracking and reporting system to maintain accurate stock levels and ensure smooth supply chain operations.",
        },
    ];