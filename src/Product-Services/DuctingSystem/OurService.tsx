    ...
    return (
        <section id="OurServices">
                <div className="pt-10 max-w-2xl mx-auto text-center mb-5 lg:mb-10 ">
                    ...
                    <p className="mt-1 text-gray-600 px-2 ">Specialized solutions for air conditioning ducting systems, ensuring efficient cooling and comfort across large-scale building projects.</p>
                </div>
    ...
    const projects = [
        {
            ...
            imageUrl: "/images/ac-ducting-service1.jpg",
            description:
                "Providing high-quality materials and professional installation of AC ducting systems tailored to building infrastructure requirements.",

        },
        {
            title: "Maintenance & Optimization",
            imageUrl: "/images/ac-ducting-service2.jpg",
            description:
                "Regular inspection and maintenance services to ensure reliable performance, air quality, and long-term efficiency of AC ducting systems.",
        },
    ];