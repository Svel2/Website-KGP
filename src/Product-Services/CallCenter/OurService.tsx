    ...
    return (
        <section id="OurServices">
                <div className="pt-10 max-w-2xl mx-auto text-center mb-5 lg:mb-10 ">
                    ...
                    <p className="mt-1 text-gray-600 px-2 ">Providing customer communication channels and service request handling with efficiency and professionalism.</p>
                </div>
    ...
    const projects = [
        {
            ...
            imageUrl: "/images/call-center-service1.jpg",
            description:
                "Assisting customers with inquiries, troubleshooting guidance, and initial resolution for technical issues.",

        },
        {
            title: "Ticketing & Escalation",
            imageUrl: "/images/call-center-service2.jpg",
            description:
                "Logging service requests, managing escalation processes, and tracking resolution progress for accountability.",
        },
        {
            title: "Monitoring Support",
            imageUrl: "/images/call-center-service3.jpg",
            description:
                "Integrating with monitoring systems to proactively detect problems and notify engineering teams for immediate action.",
        },
    ];